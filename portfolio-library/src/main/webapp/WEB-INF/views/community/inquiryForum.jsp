			...
			<div class="library-main-wrap">
				<div class="main-top-wrap">
					<div class="d-flex top-box">
						...
						</a> <i class="fa-solid fa-angle-right"></i> <span>커뮤니티</span> <i class="fa-solid fa-angle-right"></i> <a href="/community/inquiryForum"><span>게시판
								문의</span></a>
					</div>
				</div>
							...
							<div class="community-tab-wrap">
								<div class="d-flex community-tab-box">
									<a href="/community/noticeForum" class="tab">
										<p>공지 & 행사</p>
									</a> <a href="/community/inquiryForum" class="tab active">
										<p>게시판 문의</p>
							...
							<div class="inquiry-search-wrap">
								<form class="d-flex search-box" action="/community/inquiryForum" method="get">
									<div class="d-flex">
										...
										</select> <input class="me-2 book-search" type="text" name="search" aria-label="Search" placeholder="검색어를 입력해주세요" value="${pageDto.search}">
									</div>
									...
									<ul class="pagination inquiry-pagination">
										...
										<c:if test="${ pageDto.startPage gt pageDto.pageBlock }">
											<li class="page-item prev">
												<a class="page-link" href="/community/inquiryForum?pageNum=${ pageDto.startPage - pageDto.pageBlock }&category=${pageDto.category}&search=${pageDto.search}" aria-label="Previous"> 
										...
										<c:forEach var="i" begin="${ pageDto.startPage }" end="${ pageDto.endPage }" step="1">
											<li class="page-item ${ pageNum == i ? 'active' : ''}"><a class="page-link number"
												href="/community/inquiryForum?pageNum=${ i }&category=${pageDto.category}&search=${pageDto.search}"> ${ i } </a></li>
										</c:forEach>
										<c:if test="${ pageDto.endPage lt pageDto.pageCount }">
											<li class="page-item next">
												<a class="page-link" href="/community/inquiryForum?pageNum=${ pageDto.startPage + pageDto.pageBlock }&category=${pageDto.category}&search=${pageDto.search}" aria-label="Next"> 
													<span aria-hidden="true"><i class="fa-solid fa-angle-right"></i></span>
												</a>
											</li>
										</c:if>
										<li class="page-item last">
											<a class="page-link" href="/community/inquiryForum?pageNum=${pageDto.pageCount}&category=${pageDto.category}&search=${pageDto.search}">
