...
<link rel="stylesheet" href="/css/myLibrary/lossRecord.css">
</head>
<body>
			...
			<div class="library-main-wrap">
				<div class="main-top-wrap">
					<div class="d-flex top-box">
						...
						<a href="/myLibrary/lossRecord"><span class="page-now">분실기록</span></a>
					</div>
				</div>
						...
						<div class="myLibrary-main">
							...
							<c:choose>
								<c:when test="${ not empty sessionScope.id }">
									<div class="bottom-loss-wrap">
										<div class="loss-text-box">
											<p>
												총 <span class="loss-count">${ totalCount }</span>건
											</p>
										</div>
												...
												<tbody>
													<tr>
														...
														<td>
															...
															<c:if test="${ lossRecord.status eq 1 }">
																반납
															</c:if>
														</td>
													</tr>
	...
	<script>
		//대출도서 상세보기 이벤트
		$('.lossRecord-text').click(function(){
