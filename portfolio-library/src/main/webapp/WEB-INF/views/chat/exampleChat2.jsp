...
<link rel="stylesheet" href="/css/chat/exampleChat2.css">
</head>
<body>
	<div class="container">
							...
							<div class="row">
								<div class="col-lg-6">
									...
									<div class="chat-about">
										<span id="myId" class="m-b-0" th:text="${sessionScope.id}"></span>
									</div>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript" src="/js/chat/exampleChat2.js"></script>
</body>
